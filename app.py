...
DATA_FILE = '/mnt/azure/player_data.json'
...
def player():
    ...
    if name:
        try:
            ...
            player_data = {}
        logging.info(f"Player data before update: {player_data}")  # Log data before update
        ...
        logging.info(f"Player data after update: {player_data}")  # Log data after update
...
def win():
    ...
    if name:
        ...
        if name in player_data:
            ...
            with open(DATA_FILE, 'w') as f:
                json.dump(player_data, f)
            logging.info(f"Player win: {player_data}")
...
def loss():
    ...
    if name:
        ...
        if name in player_data:
            ...
            with open(DATA_FILE, 'w') as f:
                json.dump(player_data, f)
            logging.info(f"Player loss: {player_data}")
